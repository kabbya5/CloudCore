<template>
    <div class="min-h-screen bg-gray-100 flex justify-center items-center">
      <div id="authentication-form" class="bg-white shadow-2xl rounded-lg p-8 w-full max-w-md">
        <!-- Logo -->
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
            ...
            <div class="text-center text-gray-600">
                <p>Already have an account? <a href="/login" class="text-blue-600">Login here</a></p>
            </div>
        </form>
      </div>
    </div>
